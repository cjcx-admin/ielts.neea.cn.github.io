...
! function(t, e) {
    ...
    function i(t, e) {
        var n, i = e.props;
        for (n in i) !$t.test(n) || t[n] && t[n].fix || (t[n] = "convert" !== n ? r(t.constructor.prototype[n], i[n]) : i[n])
    }
    ...
    function g(t, e, n, r) {
        ...
        if (1 === n && (r = 1, n = void 0), e)
            for (o = e.split("."), s = o.length; t && l < s; l++) i = t, t = o[l] ? t[o[l]] : t;
    ...
    function _(t, e) {
        ...
        if (a = s.bindFrom, o = d.args, (l = s.convert) && "" + l === l && (l = "true" === l ? void 0 : d.view.getRsc("converters", l) || S("Unknown converter: '" + l + "'")), l && !e && (o = o.slice()), a) {
            for (i = [], n = a.length; n--;) r = a[n], i.unshift(x(d, r));
            e && (o = i)
        }
        if (l) {
            if (l = l.apply(s, i || o), void 0 === l) return o;
            if (a = a || [0], n = a.length, lt(l) && l.length === n || (l = [l], a = [0], n = 1), e) o = l;
            else
                for (; n--;) r = a[n], +r === r && (o[r] = l[n])
        }
        return o
    }
    ...
    function y(t, e, n, r, o, a) {
        function s(t) {
            var e = l[t];
            if (void 0 !== e)
                for (e = lt(e) ? e : [e], m = e.length; m--;) J = e[m], isNaN(parseInt(J)) || (e[m] = parseInt(J));
            return e || [0]
        }
        e = e || it;
        var l, d, p, u, c, f, g, m, h, w, y, k, C, T, j, A, P, R, N, M, F, V, $, I, D, J, U, q, K, L, B = 0,
            H = "",
            W = e._lc || !1,
            Z = e.ctx,
            z = n || e.tmpl,
    ...
    function C(t) {
        var e, n, r;
        for (e in Gt) n = e + "s", t[n] && (r = t[n], t[n] = {}, ot[n](r, t))
    }
    ...
    function A(t, n, r, i) {
        function o(n) {
            ...
            if ("" + n === n || n.nodeType > 0 && (a = n)) {
                if (!a)
                    if (/^\.\/[^\\:*?"<>]*$/.test(n))(s = dt[t = t || n]) ? n = s : a = document.getElementById(n);
                    else if (e.fn && !ft.rTmpl.test(n)) try {
                    a = e(n, document)[0]
                } catch (l) {}
    ...
    function N(t, n) {
        ...
        function o(t, e) {
            for (var n, r, i, o, a, s = 0; s < x; s++) i = f[s], n = void 0, i + "" !== i && (n = i, i = n.getter, a = n.parentRef), void 0 === (o = t[i]) && n && void 0 !== (r = n.defaultVal) && (o = P(r, t)), e(o, n && c[n.type], i, a)
        }
        ...
        function a(e) {
            ...
            var n, r, i, a, d = 0,
                ...
                u = [];
            if (lt(e)) {
                for (e = e || [], n = e.length; d < n; d++) u.push(this.map(e[d]));
            ...
            if (e) {
                for (o(e, function(t, e) {
                    ...
                    if (i = u[d], a = f[d].parentRef, a && i && i.unmap)
                        if (lt(i))
                            for (n = i.length; n--;) R(i[n], a, p);
                        else R(i, a, p);
                for (r in e) r === at || w[r] || (p[r] = e[r])
            }
            return p
        }
        ...
        function s(t, e, n) {
            ...
            var r, a, s, l, d, p, u, c, f, g, m = 0,
                h = this;
            if (lt(h)) {
                for (u = {}, f = [], a = t.length, s = h.length; m < a; m++) {
                    for (c = t[m], p = !1, r = 0; r < s && !p; r++) u[r] || (d = h[r], v && (u[r] = p = v + "" === v ? c[v] && (w[v] ? d[v]() : d[v]) === c[v] : v(d, c)));
        ...
        function l() {
            ...
            var e, n, r, i, o = 0,
                a = this;
            if (lt(a)) return t(a);
            for (e = {}; o < x; o++) n = f[o], r = void 0, n + "" !== n && (r = n, n = r.getter), i = a[n](), e[n] = r && i && c[r.type] ? lt(i) ? t(i) : i.unmap() : i;
        ...
        var d, p, u, c = this,
            ...
            b = e.observable,
            w = {};
        for (r.prototype = m, d = 0; d < x; d++) ! function(t) {
    ...
    function E(t, e, n, r, i, o) {
        var a, s, l, d, p, u, c, f, g = r,
            v = "";
        if (e === !0 ? (n = e, e = void 0) : typeof e !== Lt && (e = void 0), (l = this.tag) ? (p = this, g = g || p.view, d = g._getTmpl(l.template || p.tmpl), arguments.length || (t = l.contentCtx && st(l.contentCtx) ? t = l.contentCtx(t) : g)) : d = this, d) {
            if (!r && t && "view" === t._is && (g = t), g && t === g && (t = g.data), u = !g, kt = kt || u, g || ((e = e || {}).root = t), !kt || vt.useViews || d.useViews || g && g !== it) v = O(d, t, e, n, g, i, o, l);
            else {
                if (g ? (c = g.data, f = g.index, g.index = Ht) : (g = it, c = g.data, g.data = t, g.ctx = e), lt(t) && !n)
                    for (a = 0, s = t.length; a < s; a++) g.index = a, g.data = t[a], v += d.fn(t[a], g, ft);
    ...
    function J(t, e, n, r, i) {
        ...
        function s(s, l, d, c, g, x, b, w, y, k, C, T) {
            ...
            var j, A, P, R = (l || n) && [
                ...
                I = "",
                S = !y && !g;
            d = d || (w = w || "#data", g), o(T), v = T + s.length, b ? f && h.push(["*", "\n" + w.replace(/^:/, "ret+= ").replace(At, "$1") + ";\n"]) : d ? ("else" === d && (Nt.test(w) && D('For "{{else if expr}}" use "{{else expr}}"'), R = _[9] && [
                []
            ], _[10] = t.substring(_[10], T), A = _[11] || _[0] || D("Mismatched: " + s), _ = m.pop(), h = _[2], S = !0), w && L(w.replace(jt, " "), R, e, n).replace(Rt, function(t, e, n, r, i, o, a, s) {
        ...
        var l, d, p, u, c, f = gt.allowCode || e && e.allowCode || mt.allowCode === !0,
            g = [],
            v = 0,
            m = [],
            h = g,
        ...
        if (f && e._is && (e.allowCode = f), n && (void 0 !== r && (t = t.slice(0, -r.length - 2) + xt), t = ht + t + bt), a(m[0] && m[0][2].pop()[0]), t.replace(rt, s), o(t.length), (v = g[g.length - 1]) && a("" + v !== v && +v[10] === v[10] && v[0]), n) {
            for (d = B(g, t, n), c = [], l = g.length; l--;) c.unshift(g[l][9]);
            U(d, c)
        } else d = B(g, e);
        return d
    }
            ...
            if ("[" === A && (A = "[j._sq(", Q = ")]"), !k || d || l) {
                if (u && V && !d && !l && m && (U = _[m - 1], I.length - 1 > O - (U || 0))) {
                    if (U = I.slice(U, O + i.length), q !== !0)
                        if (K = a || f[m - 1].bd, L = K[K.length - 1], L && L.prm) {
    ...
    function H(t, n) {
        ...
        if (!a) {
            if (a = [], typeof t === Lt || st(t))
                for (r in t) i = t[r], r === at || !t.hasOwnProperty(r) || n.props.noFunctions && e.isFunction(i) || a.push({
                    key: r,
                    prop: i
                });
    ...
    function W(t, n) {
        ...
        if (u || p && "" + p === p ? (r = t.map(function(t, e) {
            ...
            for (i = 0, o = t.length, r = []; i < o; i += c) r.push(t[i]);
            t = r
        }
            ...
            "for": {
                ...
                render: function(t) {
                    var e, n, r, i, o, a = this,
                        ...
                        c = 0;
                    if (!a.rendering.done) {
                        if (e = p ? t : s.view.data, l)
                            for (l = d.reverse ? "unshift" : "push", i = +d.end, o = +d.step || 1, e = [], r = +d.start || 0;
                                (i - r) * o > 0; r += o) e[l](r);
                ...
                setDataMap: function(t) {
                    for (var e, n, r, i = this, o = t.length; o--;) e = t[o], n = e.props, r = e.params.props, e.argDefault = void 0 === n.end || e.args.length > 0, n.dataMap = e.argDefault !== !1 && lt(e.args[0]) && (r.sort || r.start || r.end || r.step || r.filter || r.reverse || n.sort || n.start || n.end || n.step || n.filter || n.reverse) && i.sortDataMap
                },
                flow: !0
            },
            props: {
